...
export interface RaffleInterface extends utils.Interface {
  ...
  events: {
    ...
    "RaffleWinnerPicked(address)": EventFragment;
    "RequestedRaffleWinner(uint256)": EventFragment;
  };

  getEvent(nameOrSignatureOrTopic: "RaffleEnter"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "RaffleWinnerPicked"): EventFragment;
...
export interface RaffleWinnerPickedEventObject {
  winner: string;
}
export type RaffleWinnerPickedEvent = TypedEvent<
  [string],
  RaffleWinnerPickedEventObject
>;

export type RaffleWinnerPickedEventFilter =
  TypedEventFilter<RaffleWinnerPickedEvent>;
...
export interface Raffle extends BaseContract {
  ...
  filters: {
    ...
    "RaffleWinnerPicked(address)"(
      winner?: PromiseOrValue<string> | null
    ): RaffleWinnerPickedEventFilter;
    RaffleWinnerPicked(
      winner?: PromiseOrValue<string> | null
    ): RaffleWinnerPickedEventFilter;
